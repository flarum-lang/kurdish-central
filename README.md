...
This language pack contains Kurdish (Central) translations for Flarum (compatible with `2.0.0` or newer) and popular extensions. Full list of supported extensions is available below.
...
```console
composer require "flarum-lang/kurdish-central:@dev"
```
...
| Component | Status |
| --- | --- |
| [Core](https://github.com/flarum/flarum-core) | [![Translation status](https://weblate.rob006.net/widgets/flarum2/ckb/core/svg-badge.svg)](https://weblate.rob006.net/projects/flarum2/core/ckb/) |
